...
var pixel_image = preload("res://addons/pixelorama/assets/graphics/pixel_image.png")
...
static func create_button(image : Image) -> Node:
	var button : BaseButton = load("res://addons/pixelorama/src/UI/BrushButton.tscn").instance()
